			...
			<div v-if="showLoading">
				<v-row>
					<v-col cols="12" align="center">
						<font-awesome-icon :icon="['fas', 'spinner']" pulse size="4x" />
						<h1>Signing up...</h1>
					</v-col>
				</v-row>
			</div>
			<div v-else>
				<v-row v-if="signupSubmitted">
					<v-col cols="12" align="center">
						...
						<br />
						<h4>
							Follow the email instructions to verify your account.
						</h4>
...
export default {
	...
	data() {
		return {
			...
			submittedEmail: "",
			showLoading: false,
			emailRegex: U.getEmailRegex(),
			noSpecialCharRegex: U.getNoSpecialCharRegex(),
			containsSpecialCharRegex: U.getContainsSpecialCharRegex(),
			beginsWithNumberRegex: U.getBeginsWithNumberRegex(),
